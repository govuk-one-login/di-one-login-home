...
router.get('/identity/one-login-home/v10/services-search-task-2', function(req, res) {
  const servicesPerPage = 10;
  ...
  res.render("/identity/one-login-home/v10/services-search-task-2.html", {
    test: "testing",
    page: req.query.page,
    data: finalData,
    pagination: pagination
...
router.post('/identity/one-login-home/v10/services-search-task-2', function(req, res){
  const searchQuery = req.body.search;
  let finalData = data.sort((a, b) => a.name.toUpperCase().localeCompare(b.name.toUpperCase()));
...
router.get('/identity/one-login-home/v12/services-search', function(req, res) {
  const servicesPerPage = 10;
  ...
  res.render("/identity/one-login-home/v12/services-search.html", {
    test: "testing",
    page: req.query.page,
    data: finalData,
    pagination: pagination
...
router.post('/identity/one-login-home/v12/services-search', function(req, res){
  const searchQuery = req.body.search;
  let finalData = data.sort((a, b) => a.name.toUpperCase().localeCompare(b.name.toUpperCase()));
